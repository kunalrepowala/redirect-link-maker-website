...
# MongoDB for storing TeraLink and Redirection links (write operations)
...
# -----------------------
# Global Variables for Verification and Daily Limit (for TeraLink embed pages)
# -----------------------
...
# For uniqueness, we supply explicit endpoint names in our decorators.
...
def generate_teralink():
    ...
    # Insert into MongoDB collection (read/write)
...
# -----------------------
# /verify and /check_verification Endpoints – For TeraLink embed pages
# -----------------------
...
def start_bot():
    ...
    try:
        ...
        # Log the error and pass (this may occur during shutdown)
...
if __name__ == '__main__':
    # Listen on all interfaces and use port 8080 (for Koyeb deployment)
